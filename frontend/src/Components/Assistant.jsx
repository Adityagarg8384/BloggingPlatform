...
const Assistant = ({state,setState}) => {
    return (
        <div>
            <div className={`bg-red-400 text-xl fixed right-10 bottom-10 rounded-lg duration-200 ease-in-out flex justify-between items-start p-3 ${state ? "w-[15%] h-[30%]" : 'w-[0%] h-[0%]' }`}>
                {   
                    state && 
                    <div>
                        Open
